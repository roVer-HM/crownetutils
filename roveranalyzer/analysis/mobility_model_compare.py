"""Comparison of communication metrics based on different mobility models.

    Mobility models taken:
        * Vadere (Optimal Steps Model)
        * Sumo (Striping Model)
"""
...
from roveranalyzer.omnetpp.scave import ScaveTool

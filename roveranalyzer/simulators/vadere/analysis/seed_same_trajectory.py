...
class SameSeedTrajectory:
    ...
    def find_same_scenarios(self):
        """
        Search through the output directory of the vadereanalyzer project and group all output together, which have the same
    ...
    def get_trajectory_comparison_result(self):
        ...
        for scenario_hash in same_scenarios:
            ...
            ret["scenario_outputs"] = [
                (scenario.output_dir_name, scenario.trajectories_hash)

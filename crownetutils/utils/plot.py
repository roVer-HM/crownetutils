...
def enb_patch(
    ...
    vert = np.array(
        [
            [0.64816883, 0.47692308][0.68010268, 0.51538459][0.69908441, 0.56289593][
                0.69908441, 0.61447964
            ][0.69908441, 0.66628958][0.68010268, 0.71380092][0.64816883, 0.7520362][
    ...
    p = p.transformed(pltTrans.Affine2D().translate(tx=pos_xy[0], ty=pos_xy[1]))

...
from crownetutils.analysis.hdf.provider import UnsupportedOperation
...
class IHDFProviderTest(unittest.TestCase):
    ...
    @patch("crownetutils.analysis.hdf.provider.IHdfProvider.dispatch")
    ...
    @patch("crownetutils.analysis.hdf.provider.IHdfProvider.dispatch")
    @patch("crownetutils.analysis.hdf.provider.IHdfProvider._handle_index_tuple")
    @patch("crownetutils.analysis.hdf.provider.IHdfProvider.cast_to_set")
    ...
    @patch("crownetutils.analysis.hdf.provider.IHdfProvider.dispatcher")
